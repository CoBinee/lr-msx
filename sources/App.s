...
appColorTable:
    ...
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_BLACK        << 4) | VDP_COLOR_MEDIUM_RED, (VDP_COLOR_BLACK        << 4) | VDP_COLOR_MEDIUM_RED
    .db     (VDP_COLOR_BLACK        << 4) | VDP_COLOR_MEDIUM_RED, (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_LIGHT_GREEN  << 4) | VDP_COLOR_BLACK,      (VDP_COLOR_CYAN         << 4) | VDP_COLOR_BLACK
    ...
    .db     (VDP_COLOR_LIGHT_YELLOW << 4) | VDP_COLOR_DARK_BLUE,  (VDP_COLOR_DARK_YELLOW  << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_LIGHT_GREEN  << 4) | VDP_COLOR_DARK_BLUE,  (VDP_COLOR_CYAN         << 4) | VDP_COLOR_DARK_BLUE
